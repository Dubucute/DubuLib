...
function GUI:CreateMain(config)
    ...
    MinimizeButton.MouseButton1Click:Connect(function()
        ...
        if minimized then
            Main:TweenSize(UDim2.new(0, 680, 0, 40), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.3)
            MinimizeButton.Text = "☐"
        else
            Main:TweenSize(UDim2.new(0, 680, 0, 450), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.3)
            MinimizeButton.Text = "─"
        end
    end)
